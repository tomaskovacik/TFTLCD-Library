...
void setup(void) {
  ...
  if (identifier == 0x9481) {
    ...
    Serial.println(F("For chines 3.5\" LCD based on ILI9481B chip, uncoment line:"));
    Serial.println(F("  #define _35_ILI9481_SHIELD"));
    Serial.println(F("in the library header (Adafruit_TFT.h)."));
    return;
  }
